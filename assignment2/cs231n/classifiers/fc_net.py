    ...
    def loss(self, X, y=None):
        ...
        for i in range(self.num_layers, 0, -1):
            ...
            if i == self.num_layers:
                ...
                if self.normalization == 'batchnorm' :
                    der, grads[W_name], grads[b_name], grads[gamma_name], grads[beta_name] = affine_batchnorm_relu_backward(der, self.cache[cache_name])
                elif self.normalization == 'layernorm' :
                    der, grads[W_name], grads[b_name], grads[gamma_name], grads[beta_name] = affine_layernorm_relu_backward(der, self.cache[cache_name])
